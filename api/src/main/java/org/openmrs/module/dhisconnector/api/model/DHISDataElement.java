...
@JsonPropertyOrder({ "id", "created", "name", "code", "href", "lastUpdated", "shortName", "zeroIsSignificant",
...
public class DHISDataElement {
	...
	/**
	 * @param zeroIsSignificant The zeroIsSignificant
	 */
	@JsonProperty("zeroIsSignificant")
	...
	/**
	 * @param dataDimension The dataDimension
	 */
	@JsonProperty("dataDimension")
	...
	/**
	 * @return The aggregationOperator
	 */
	@JsonProperty("aggregationOperator")
	...
	/**
	 * @param aggregationOperator The aggregationOperator
	 */
	@JsonProperty("aggregationOperator")
	...
	/**
	 * @param numberType The numberType
	 */
	@JsonProperty("numberType")
	...
	/**
	 * @param optionSetValue The optionSetValue
	 */
	@JsonProperty("optionSetValue")
	...
	/**
	 * @param aggregationLevels The aggregationLevels
	 */
	@JsonProperty("aggregationLevels")
	...
	/**
	 * @param dataElementGroups The dataElementGroups
	 */
	@JsonProperty("dataElementGroups")
