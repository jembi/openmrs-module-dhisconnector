...
/**
 * <p>
 * Java class for adxType complex type.
 * <p>
...
public class AdxDataValueSet {
	
	
	@XmlElement(required = true)
	protected List<AdxDataValueGroup> group;
	...
	public AdxDataValueSet() {
	}
	
	public AdxDataValueSet(AdxDataValueGroup group, XMLGregorianCalendar exported) {
		getGroups().add(group);
	 ...
	 * </pre>
	 * <p>
	 * Objects of the following type(s) are allowed in the list {@link AdxDataValueGroup }
	 */
	public List<AdxDataValueGroup> getGroups() {
		if (group == null) {
			group = new ArrayList<AdxDataValueGroup>();
		}
		return this.group;
	}
