 ...
 * <br />
 * 
 * @see <a href= "https://docs.dhis2.org/2.22/en/developer/html/dhis2_developer_manual_full.html">
 *      DHIS 2.22 Dev Manual</a> <br />
 *      DHIS period types and examples
 *      <table class="table" summary="Period format" border="1">
 *      <colgroup><col width="60pt" class="c1"><col width="80pt" class="c2"><col width="80pt" class=
 *      "c3"><col width="200pt" class="c4"></colgroup><thead>
 *      <tr>
 *      <th>Interval</th>
 *      <th>Format</th>
 *      <th>Example</th>
 ...
 *      <tr>
 *      <td>Week</td>
 *      <td><span class="emphasis"><em>yyyy</em></span>W<span class="emphasis"> <em>n</em></span>
 *      </td>
 *      <td>2004W10</td>
 *      <td>Week 10 2004</td>
 *      </tr>
 ...
 *      <tr>
 *      <td>Quarter</td>
 *      <td><span class="emphasis"><em>yyyy</em></span>Q<span class="emphasis"> <em>n</em></span>
 *      </td>
 *      <td>2004Q1</td>
 ...
 *      <tr>
 *      <td>Six-month</td>
 *      <td><span class="emphasis"><em>yyyy</em></span>S<span class="emphasis"> <em>n</em></span>
 *      </td>
 *      <td>2004S1</td>
...
public enum DHISPeriodTypeUnit {
	DAILY("Daily", "\\b(\\d{4})(\\d{2})(\\d{2})\\b"), WEEKLY("Weekly", "\\b(\\d{4})W(\\d[\\d]?)\\b"), MONTHLY("Monthly",
	        "\\b(\\d{4})[-]?(\\d{2})\\b"), BI_MONTHLY("BiMonthly", "\\b(\\d{4})(\\d{2})B\\b"), QUARTERLY("Quarterly",
	                "\\b(\\d{4})Q(\\d)\\b"), SIX_MONTHLY("SixMonthly", "\\b(\\d{4})S(\\d)\\b"), SIX_MONTHLY_APRIL(
	                        "SixMonthlyApril",
	                        "\\b(\\d{4})AprilS(\\d)\\b"), YEARLY("Yearly", "\\b(\\d{4})\\b"), FINANCIAL_APRIL(
	                                "FinancialApril", "\\b(\\d{4})April\\b"), FINANCIAL_JULY("FinancialJuly",
	                                        "\\b(\\d{4})July\\b"), FINANCIAL_OCTOBER("FinancialOct", "\\b(\\d{4})Oct\\b");
	...
	public static String getPeriodTypeFromIsoString(String isoPeriod) {
		DHISPeriodTypeUnit dateUnitType = find(isoPeriod);
