...
public class DHISDataSet {
     ...
     * 
     * @return
     *     The compulsoryDataElementOperands
     */
    @JsonProperty("compulsoryDataElementOperands")
